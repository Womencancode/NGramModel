...
class TestMain(TestCase):
    ...
    def test__make_ngrams_pre_word_True(self):
        ...
        actual = self.main._make_ngrams(tokenized_corpus=self.corpus3_tokens_n4, corpus_token_index=6, n=4,
    ...
    def test_compute_perplexity(self):
        ...
        actual = self.main.compute_perplexity(train_corpus=self.corpus4, test_corpus='I like', n=2)
